...
DETECTION_COLOR_MAP = {0: (1,1,0), 1: (0, 1, 1), 2: (0.5, 0.2, 1),3:(0,1,0),4:(0.5,1,0.2)} # color for detection, in format bgr
...
def publish_3dbox(box3d_pub, corners_3d_velos, texts=None, types=None, speeds=None, track_color=False, Lifetime=100):
    ...
    for i, corners_3d_velo in enumerate(corners_3d_velos):
        ...
        if speeds is not None:
            ...
            speed_norm = 0 if speed_norm < 0.02 else speed_norm * 36
