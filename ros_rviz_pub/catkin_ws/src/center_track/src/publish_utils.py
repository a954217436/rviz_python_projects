...
def publish_3dbox(box3d_pub, corners_3d_velos, texts=None, types=None, speeds=None, track_color=False, Lifetime=100):
    ...
    for i, corners_3d_velo in enumerate(corners_3d_velos):
        ...
        if speeds is not None:
            ...
            p_end = p_start + speeds[i] * 1
            z = corners_3d_velo[5][2] / 2.0
            Point_start = Point(p_start[0], p_start[1], z)
            Point_end = Point(p_end[0], p_end[1], z)
...
def publish_centers(center_pub, centers, radius=1, Lifetime=100, texts=None, types=None, speeds=None, track_color=False,):
    marker_array = MarkerArray()
    for i, center in enumerate(centers):
        ...
        if speeds is not None:
            # speed arrow
            Point_start = Point(center[0], center[1], center[2] + 0.5)
            Point_end = Point(center[0] + speeds[i][0], center[1] + speeds[i][1], center[2] + 0.5)
            speed_marker = get_arrow_marker(Point_start, Point_end, Lifetime, i+2000, (0,255,0))
