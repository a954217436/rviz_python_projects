...
def get_obj(path):
    path = "/home/zhanghao/code/master/4_TRACK/CenterPointZH/" + path
...
def convert_detection_to_global_box(detections, infos):
    ...
    for token in tqdm(detections.keys()):
        ...
        for i in range(num_box):
            anno = {
                ...
                # 'translation': box3d[i, [0,1,2,3,4,5,8]],  # zhanghao
                'local_box': local_box[i, [0,1,2,3,4,5,8]],  # zhanghao
